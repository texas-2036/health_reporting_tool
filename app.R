...
header <- dashboardHeader(disable = FALSE,
                          title = tags$a(href='http://www.texas2036.org',
                                         ...
                                         tags$title('The Health of Texans')))
# SIDEBAR CODE  ------------------------------------------------------------
...
body <- dashboardBody(
  ...
  #             $("header").find("nav").append(\'<span class="myTitle"> The Health of Texans </span>\');
  #     })')),
  tags$head(
  ...
  meta() %>%
    meta_social(
      title = "Texas 2036 | The Health of Texans",
      description = "A comprehensive look at the health of the Lone Star State.",
      url = "http://healthy.texas2036.org",
      image = "https://texas-2036.github.io/covid-pages/images/trends_cover.png",
      image_alt = "Texas 2036 | Health of Texans",
  ...
  tabItems(
    tabItem(tabName = "intro",
            jumbotron("The Health of Texas", 
                      "A Comprehensive Check-Up on The Lone Star State",
                      button = FALSE),
            hr(class="landing-hr"),
            ...
            br(),
            fluidRow(
              column(3, thumbnail_label(title="<i class='fad fa-baby-carriage fa-3x' style='color:#EAEFF6'></i>",
                                        label = 'Maternity',
                                        content = "Content",
                                        button_link ='maternity_overview', 
                                        button_label = 'Explore')),
              column(3, thumbnail_label(title="<i class='fad fa-child fa-3x' style='color:#EAEFF6'></i>", 
                                        label = 'Childhood',
                                        content = "Content",
                                        button_link ='childhood_overview', 
                                        button_label = 'Explore')),
              column(3, thumbnail_label(title="<i class='fad fa-user-hard-hat fa-3x' style='color:#EAEFF6'></i>", 
                                        label = 'Working Age',
                                        content = "Content",
                                        button_link ='working_overview', 
                                        button_label = 'Explore')),
              column(3, thumbnail_label(title="<i class='fad fa-user-friends fa-3x' style='color:#EAEFF6'></i>",
                                        label = 'Aging',
                                        content = "Content",
                                        button_link ='aging_overview', 
                                        button_label = 'Explore'))
            )),
    # **Maternity Section ---------------------------------------------------------------------------
...
server <- function(input, output) { 
  ...
  # aging_overview_server("overview")
  # aging_rf_server("rf_charts")
  # aging_cnd_server("cnd_charts")
  # aging_pol_server("pol_charts")
